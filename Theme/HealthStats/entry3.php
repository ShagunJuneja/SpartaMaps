...
$quer2 = mysql_query("SELECT * FROM ojasprof WHERE id=3");
if(!$quer2)
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h5 id='footer-header'> Pages </h3>
                            <ul class="pagination">
                                <li class="page-item">
                                    <a class="page-link" href="entry2.php" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                </li>
                                <li class="page-item"><a class="page-link" href="index.php">1</a></li>
                                <li class="page-item"><a class="page-link" href="entry1.php">2</a></li>
                                <li class="page-item"><a class="page-link" href="entry2.php">3</a></li>
                                <li class="page-item">
